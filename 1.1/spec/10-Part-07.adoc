...
|MinX(sf:Geometry) | Returns the minimum X coordinate of all geometries | xsd:double | 
|MaxX(sf:Geometry) | Returns the maximum X coordinate of all geometries | xsd:double | 
|MinY(sf:Geometry) | Returns the minimum Y coordinate of all geometries | xsd:double | 
|MaxY(sf:Geometry) | Returns the maximum Y coordinate of all geometries | xsd:double | 
|MinZ(sf:Geometry) | Returns the minimum Z coordinate of all geometries | xsd:double | 
|MaxZ(sf:Geometry) | Returns the maximum Z coordinate of all geometries | xsd:double | 
|geosf:BBOX(sf:Geometry) | Calculates a minimum bounding box of the set of given geometries | xsd:double | 
|geosf:CENTROID(sf:LineString) | Calculates the centroid of the set of given geometries | sf:Geometry | 
...
|geosf:UNION(sf:Geometry) | Calculates the union of the set of given geometries   | xsd:double | 
|===
